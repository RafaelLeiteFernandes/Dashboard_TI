...
var OpenDayTickets_controller_exports = {};
__export(OpenDayTickets_controller_exports, {
  getTicketsCreatedToday: () => getTicketsCreatedToday
});
module.exports = __toCommonJS(OpenDayTickets_controller_exports);
...
var getTicketsCreatedToday = async (req, res) => {
  try {
    ...
    const ticketsCreatedToday = await Tickets.count({
      where: {
        date_creation: {
          [import_sequelize3.Op.between]: [startOfDay, endOfDay]
        }
      }
    });
