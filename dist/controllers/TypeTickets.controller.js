...
var TypeTickets_controller_exports = {};
__export(TypeTickets_controller_exports, {
  getTicketsByCategory: () => getTicketsByCategory
});
module.exports = __toCommonJS(TypeTickets_controller_exports);
...
var getTicketsByCategory = async (req, res) => {
  try {
    const ticketsByCategory = await Tickets.findAll({
      attributes: ["itilcategories_id", [sequelize2.fn("COUNT", "*"), "count"]],
