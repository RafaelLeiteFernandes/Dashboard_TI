...
var MonTickets_controller_exports = {};
__export(MonTickets_controller_exports, {
  getClosedTicketsByMonth: () => getClosedTicketsByMonth
});
module.exports = __toCommonJS(MonTickets_controller_exports);
...
var sequelize2 = new import_sequelize3.Sequelize(process.env.PG_DB, process.env.PG_USER, process.env.PG_PASSWORD, {
  host: "localhost",
  dialect: "mysql"
});
var getClosedTicketsByMonth = async (req, res) => {
  try {
    const closedTicketsByMonth = await Tickets.findAll({
      attributes: [
        [(0, import_sequelize3.fn)("YEAR", (0, import_sequelize3.col)("solvedate")), "year"],
        [(0, import_sequelize3.fn)("MONTH", (0, import_sequelize3.col)("solvedate")), "month"],
        [(0, import_sequelize3.fn)("COUNT", "*"), "count"]
      ],
      where: {
        status: 6
        // Supondo que o status 6 representa chamados fechados
      },
      group: [(0, import_sequelize3.fn)("YEAR", (0, import_sequelize3.col)("solvedate")), (0, import_sequelize3.fn)("MONTH", (0, import_sequelize3.col)("solvedate"))],
      raw: true
    });
